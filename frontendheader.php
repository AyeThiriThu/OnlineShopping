						...
						<div class="row w-100">
							...
							<div class="col-lg-5">
								<ul class="nav navbar-nav navbar-right right_nav pull-right">
									...
									<li class="nav-item submenu dropdown">
										<a href="#" class="dropdown-toggle icons" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i></a>
										<ul class="dropdown-menu">
											<li class="nav-item">
												<a class="nav-link" href="login.html"><?php echo $_SESSION['loginuser']['name'] ?></a>
												<li class="nav-item">
													<a class="nav-link" href="tracking.html">Order</a>
													<li class="nav-item">
